/*
------------------------------------------------------------------------------
  Pubs Sample Database (MySQL Version)
  ------------------------------------
  Original Source : Microsoft SQL Server "Pubs" Sample Database
  Converted For   : MySQL 8.0+
  Author          : hikari00-hub
  Date            : 2025-11-07
  ------------------------------------------------------------------------------
*/
...
CREATE TABLE authors (
  au_id VARCHAR(11) NOT NULL
    CHECK (au_id REGEXP '^[0-9]{3}-[0-9]{2}-[0-9]{4}$'),
...
CREATE TABLE titles (
  -- SQL Server 中的自定义类型 tid，这里按 Pubs 示例转换为 VARCHAR(6)
  ...
  -- SQL Server money → MySQL 用 DECIMAL(19,4) 替代
  ...
  -- SQL Server datetime 默认 getdate() → MySQL 用 CURRENT_TIMESTAMP
...
CREATE TABLE jobs (
  ...
  min_lvl SMALLINT UNSIGNED NOT NULL 
    CHECK (min_lvl >= 10),
  max_lvl SMALLINT UNSIGNED NOT NULL 
    CHECK (max_lvl <= 250),
...
CREATE TABLE employee (
  emp_id VARCHAR(9) NOT NULL
    CHECK (
      emp_id REGEXP '^[A-Z]{3}[1-9][0-9]{4}[FM]$'
      OR emp_id REGEXP '^[A-Z]-[A-Z][1-9][0-9]{4}[FM]$'
    ),
  ...
  job_lvl SMALLINT UNSIGNED DEFAULT 10,
...
BEGIN
  ...
  IF NEW.job_id = 1 AND NEW.job_lvl <> 10 THEN
    SET v_msg := 'Job id 1 expects the default level of 10.';
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = v_msg;
  END IF;

  /* 读取岗位等级范围 */
  SELECT min_lvl, max_lvl INTO v_min, v_max
  FROM jobs
  ...
  IF v_min IS NULL OR v_max IS NULL THEN
    SET v_msg := CONCAT('Invalid job_id: ', NEW.job_id);
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = v_msg;
  END IF;

  /* 等级越界 */
  IF NEW.job_lvl < v_min OR NEW.job_lvl > v_max THEN
    SET v_msg := CONCAT('The level for job_id ', NEW.job_id,
                        ' should be between ', v_min, ' and ', v_max, '.');
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = v_msg;
  END IF;
END$$
...
('0736', X'',
...
('0877', X'',
...
('1622', X'',
...
('1756', X'',
...
('9901', X'',
'This is sample text data for GGG&G, publisher 9901 in the pubs database. GGG&G is located in München, Germany.'),
('9952', X'',
...
('9999', X'',
...
'1991-06-12'),
('PS7777', 'Emotional Security: A New Algorithm', 'psychology', '0736',
7.99, 4000.00, 10, 3336,
...
'1991-06-09'),
('TC7777', 'Sushi, Anyone?', 'trad_cook', '0877',
14.99, 8000.00, 10, 4095,
'Detailed instructions on how to make authentic Japanese sushi in your spare time.',
'1991-06-12'),
('TC4203', 'Fifty Years in Buckingham Palace Kitchens', 'trad_cook', '0877',
11.95, 4000.00, 14, 15096,
...
'1991-06-30'),
('PS2091', 'Is Anger the Enemy?', 'psychology', '0736',
10.95, 2275.00, 12, 2045,
'Carefully researched study of the effects of strong emotions on the body. Metabolic charts included.',
'1991-06-15'),
('PS2106', 'Life Without Fear', 'psychology', '0736',
7.00, 6000.00, 10, 111,
...
2.99, 15000.00, 24, 22246,
'Traditional French gourmet recipes adapted for modern microwave cooking.',
'1991-06-18'),
('TC3218', 'Onions, Leeks, and Garlic: Cooking Secrets of the Mediterranean', 'trad_cook', '0877',
20.95, 7000.00, 10, 375,
...
NULL, NULL, NULL, NULL, NULL, '2025-10-21'),
...
'1991-06-22'),
('PS1372', 'Computer Phobic AND Non-Phobic Individuals: Behavior Variations', 'psychology', '0877',
21.59, 7000.00, 10, 375,
...
NULL, NULL, NULL, NULL,
'A must-read for computer conferencing.', '2025-10-21');
...
('M-R38834F','Martine',NULL,'Rance',9,75,'0877','1992-02-05'),
...
('R-M53550M','Roland',NULL,'Mendel',11,150,'0736','1991-09-05'),
...
('M-L67958F','Maria',NULL,'Larsson',7,135,'1389','1992-03-27'),
...
('A-R89858F','Annette',NULL,'Roulet',6,152,'9999','1990-02-21'),
('HAN90777M','Helvetius','A','Nagy',7,120,'9999','1993-03-19'),
('M-P91209M','Manuel',NULL,'Pereira',8,101,'9999','1989-01-09'),
...
DELIMITER $$
CREATE PROCEDURE byroyalty(IN p_percentage INT)
BEGIN
  SELECT au_id
  FROM titleauthor
  WHERE royaltyper = p_percentage;
END$$
...
BEGIN
  ...
  GROUP BY t.pub_id, t.type WITH ROLLUP;
END$$

CREATE PROCEDURE reptq3(IN p_lolimit DECIMAL(19,4),
                        IN p_hilimit DECIMAL(19,4),
                        IN p_type CHAR(12))
BEGIN
  SELECT
    CASE WHEN GROUPING(pub_id) = 1 THEN 'ALL' ELSE pub_id END AS pub_id,
  ...
  FROM titles
  WHERE (price > p_lolimit AND price < p_hilimit AND type = p_type)
     OR (type LIKE '%cook%')
